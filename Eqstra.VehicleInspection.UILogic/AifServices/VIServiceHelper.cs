    ...
    public class VIServiceHelper
    {
        ...
        public VIService.MzkVehicleInspectionServiceClient ConnectAsync(string userName, string password, IEventAggregator eventAggregator, string domain = "lfmd")
        {
            try
            {
                ...
                basicHttpBinding.Security.Transport.ClientCredentialType = HttpClientCredentialType.Windows;//http://srfmlbispstg01.lfmd.co.za/MicrosoftDynamicsAXAif60/VehicleInspection/xppservice.svc
                client = new VIService.MzkVehicleInspectionServiceClient(basicHttpBinding, new EndpointAddress("http://srfmlaxtest01/MicrosoftDynamicsAXAif60/VehicleInspection/xppservice.svc"));
